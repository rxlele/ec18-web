...
body {
  ...
  min-height: 100vh;
	...
	%>
    <h2 align="center" >Prodotti più cliccati</h2><br><br>
  ...
  <div class="row">
    <div class="col	">
            ...
            <div class="col-7">
                ...
                <a href="#" class="list-group-item" >Più cliccati <span class="glyphicon glyphicon-tag pull-right"></span></a>
    ...
    <div class="col">
      <p><b>Totale prodotti:</b> <%= request.getAttribute("total") %> </p><br><br>
      <p><b>Prodotto più cliccato:</b>  ${ itemList[0].name } </p><br><br>
      <c:set var="size" value="${fn:length(itemList)}" />
       <p><b>Prodotto meno cliccato:</b>  ${ itemList[size-1].name }</p>
