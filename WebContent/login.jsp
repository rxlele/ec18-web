...
if (session.getAttribute("cart")!=null){
   ...
   <% } } }%>
    <a class="p-2 text-dark" href="#"> <span class="fas fa-user-circle"></span> Login</a>
  </nav>
...
<div class="container">
	<div class="registration mx-auto d-block w-100">
		...
		<br><br>
		<form id="member-registration" method="POST" action="LoginUser.do" class="form-validate form-horizontal well">
			<fieldset>
				...
				<div class="form-group">
				  ...
				  <div class="form-group">
              <input id="password-field" type="password" class="form-control" name="passwd" required>
              <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
            </div>
				 	
				 	<!--  
				 	<div class="input-group mb-3">
				 	<input id="exampleInputEmail1" class="form-control" name="passwd" type="password" required>  	
 						 <div class="input-group-append">
   							 <button onclick="showPassword();"class="btn btn-outline-primary"  type="button"><i id="eyebutton" class="far fa-eye"></i></button>
 						 </div>
					</div>
				...
				if (request.getHeader("referer")!=null){
					if (request.getHeader("referer").contains("login.jsp") || request.getHeader("referer").contains("LoginUser.do"))
						out.println("<span class=\"cred\">Credenziali errate. Si prega di riprovare.</span><br><br>");
				}
				%>
