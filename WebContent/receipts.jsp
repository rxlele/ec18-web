...
body {
  ...
  min-height: 100vh;
	...
	%>
    <h2 align="center" >Incassi settimanali</h2><br><br>
  ...
  <div class="row">
    <div class="col	">
            ...
            <div class="col-7">
                ...
                <div class="panel list-group" >
                 ...
                 <a href="#" class="list-group-item" >Incassi <span class="glyphicon glyphicon-tag pull-right"></span></a>
    ...
    <div class="col">
      <p><b>Totale incassi settimanali:</b> € <%= request.getAttribute("totalWeekly") %>0</p><br><br>
      <p><b>Totale incassi:</b> €  <%= request.getAttribute("totalReceipts") %>0</p><br><br>
       <p><b>Giorno con più incassi:</b> <%= request.getAttribute("bestDate")%> (€ <%= request.getAttribute("bestReceipt") %>0)</p>
          ...
          <div class="row py-3">
            ...
            <div class="col-md-3">
              <div class="d-inline-block">
                  <a class="fab fa-google-play fa-2x"  href="https://play.google.com/store/apps/details?id=ingsw" style="color:white; "></a>
...
for (i=6;i>=0;i--){
	days.push(formatDate(i));
}	
<c:forEach items="${receiptsList}" var="i">
	data.push("${i}");
</c:forEach>
